...
def st_button(icon, url, label, iconsize):
    ...
    elif icon == 'stackoverflow':
        button_code = f'''
        <p>
            <a href={url} class="btn btn-outline-primary btn-lg btn-block" type="button" aria-pressed="true">    
            <svg id="changeColor" fill="#DC7633" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width={iconsize} height={iconsize} zoomAndPan="magnify" viewBox="0 0 375 374.9999" preserveAspectRatio="xMidYMid meet" version="1.0"><defs>&lt;</defs><g></g><g></g><g clip-path="url(#id3)"></g><g clip-path="url(#id4)"></g><g id="inner-icon" transform="translate(85, 75)"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="IconChangeColor" height="199.8" width="199.8"> <g> <path fill="none" d="M0 0h24v24H0z" id="mainIconPathAttribute"></path> <path d="M18 20.002V15h2v7.002H4V15h2v5.002h12zM7.5 18v-2h9v2h-9zm.077-4.38l.347-1.97 8.864 1.563-.348 1.97-8.863-1.563zm1.634-5.504l1-1.732 7.794 4.5-1 1.732-7.794-4.5zm3.417-4.613l1.532-1.286 5.785 6.895-1.532 1.285-5.785-6.894z" id="mainIconPathAttribute"></path> </g> </svg> </g></svg>
            {label}
            </a>
        </p>''' 
...
st.markdown('<h1 class = "title_home" >Contacts </h1>',unsafe_allow_html = True)

st_button('twitter', 'https://twitter.com/matta_georges/', 'Follow me on Twitter', icon_size)
st_button('linkedin', 'https://www.linkedin.com/in/georges-matta-2a62a217b/', 'Follow me on LinkedIn', icon_size)
st_button('gmail', 'https://www.gmail.com/',    'Send me email', icon_size)
st_button('stackoverflow', 'https://stackoverflow.com/users/5980666/devleb2022', 'check my stackoverflow', icon_size)
st_button('github', 'https://github.com/devleb', 'check my repo', icon_size)
